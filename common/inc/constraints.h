...
#define MAX_REPORTS_PER_PACKET          5//13 //(uint32_t) (MAX_PACKET_SIZE/SINGLE_NODE_REPORT_SIZE) // WARNING: THIS HAS TO BE REPLICATED INTO THE GATEWAY SCRIPT /vela-lab/gateway/dev/sink_integration/main.py
