...
#define FIRST_PCB_WORKAROUND
	...
	#define SERIAL_BUFF_RX_SIZE	128                       //do not touch this. For some reason by setting it to 1 the RTS pin keeps toggling and the MCU never goes to sleep
    ...
    #define UART_TX_PIN_NUMBER              NRF_GPIO_PIN_MAP(0,24)
		...
		#define UART_FLOW_CONTROL 				APP_UART_FLOW_CONTROL_ENABLED //NRF_UART_HWFC_ENABLED//NRF_UART_HWFC_ENABLED
		#define UART_PARITY_ENABLED 			NRF_UART_PARITY_EXCLUDED
