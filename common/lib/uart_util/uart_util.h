...
#define SERIAL_FIFOS_SIZE 128                         /**< UART TX buffer (FIFO) size. */
	...
	#define SERIAL_BUFF_RX_SIZE	1
		...
		#define UART_BAUDRATE 					UART_BAUDRATE_BAUDRATE_Baud921600
	#else
		...
		#define UART_PARITY_ENABLED 			NRF_UART_PARITY_EXCLUDED
		#define UART_BAUDRATE 					UART_BAUDRATE_BAUDRATE_Baud921600 //NB: check the baudrate, some settings are nonstandard. See UART_BAUDRATE_BAUDRATE_Baud921600 in nrf52_bitfields.h
	#endif
#else	//CONTIKI
	#include <stddef.h>
#endif
