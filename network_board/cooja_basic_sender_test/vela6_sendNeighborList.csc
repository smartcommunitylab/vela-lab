...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>vela_sink</description>
      <source>[CONFIG_DIR]/vela_sink.c</source>
      <commands>make vela_sink.cooja TARGET=cooja</commands>
    ...
    <motetype>
      ...
      <description>vela_node</description>
      <source>[CONFIG_DIR]/vela_node.c</source>
      <commands>make vela_node.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>56.75180225874714</x>
        <y>16.647686049553236</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype641</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>75.00410172152795</x>
        <y>43.774216572806864</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>53.57366899706514</x>
        <y>47.76137901686341</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>25.320801474559104</x>
        <y>77.56473638508935</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>113.7274156625928</x>
        <y>52.994133573348456</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>103.37426085613345</x>
        <y>71.70461119152773</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.9757319623115914 0.0 0.0 2.9757319623115914 -2.1496266476161363 -28.753471206295533</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
